...
private static handleValidationResult(validationResult: any, res: Response): void {
    if (!validationResult.valid) {
        ...
        res.status(statusCode).json({ error: validationResult.error });
    } else {
...
static validatePassport(req: Request, res: Response): void {
    ...
    if (!passportNumber || !countryCode) {
        res.status(400).json({ error: 'Passport number and country code are required.' });
...
static validateCPF(req: Request, res: Response): void {
    ...
    if (!cpfNumber) {
        res.status(400).json({ error: 'CPF number is required.' });
        return; // Exit the function early
    }
...
static validateRG(req: Request, res: Response): void {
    ...
    if (!rgNumber) {
        res.status(400).json({ error: 'RG number is required.' });
        return; // Exit the function early
    }
...
static validateSUS(req: Request, res: Response): void {
    ...
    if (!susNumber) {
        res.status(400).json({ error: 'SUS number is required.' });
        return; // Exit the function early
    }
...
static validateCNH(req: Request, res: Response): void {
    ...
    if (!cnhNumber) {
        res.status(400).json({ error: 'CNH number is required.' });
        return;
    }
...
static validateCTPS(req: Request, res: Response): void {
    ...
    if (!ctpsNumber) {
        res.status(400).json({ error: 'CTPS number is required.' });
        return;
    }
...
static validateCRM(req: Request, res: Response): void {
    ...
    if (!crmNumber) {
        res.status(400).json({ error: 'CRM number is required.' });
        return;
    }
...
static validateOAB(req: Request, res: Response): void {
    ...
    if (!oabNumber) {
        res.status(400).json({ error: 'OAB number is required.' });
        return;
    }
...
static validateCREA(req: Request, res: Response): void {
    ...
    if (!creaNumber) {
        res.status(400).json({ error: 'CREA number is required.' });
        return;
    }
...
static validatePIS(req: Request, res: Response): void {
    ...
    if (!pisNumber) {
        res.status(400).json({ error: 'PIS number is required.' });
        return;
    }
...
static validateCNPJ(req: Request, res: Response): void {
    ...
    if (!cnpjNumber) {
        res.status(400).json({ error: 'CNPJ number is required.' });
        return;
    }
...
static validateUSDriversLicense(req: Request, res: Response): void {
    ...
    if (!licenseNumber) {
        res.status(400).json({ error: 'US Driver\'s License number is required.' });
        return;
    }
...
static validateUSSSN(req: Request, res: Response): void {
    ...
    if (!ssn) {
        res.status(400).json({ error: 'US SSN is required.' });
        return;
    }
...
static validateUSMilitaryID(req: Request, res: Response): void {
    ...
    if (!militaryID) {
        res.status(400).json({ error: 'US Military ID is required.' });
        return;
    }
...
static validateUKNINumber(req: Request, res: Response): void {
    ...
    if (!niNumber) {
        res.status(400).json({ error: 'UK NI Number is required.' });
        return;
    }
...
static validateCanadianSIN(req: Request, res: Response): void {
    ...
    if (!sinNumber) {
        res.status(400).json({ error: 'Canadian SIN Number is required.' });
        return;
    }
...
static validateMexicanCURP(req: Request, res: Response): void {
    ...
    if (!curpNumber) {
        res.status(400).json({ error: 'Mexican CURP Number is required.' });
        return;
    }
...
static validateSouthKoreanRRN(req: Request, res: Response): void {
    ...
    if (!rrnNumber) {
        res.status(400).json({ error: 'South Korean RRN Number is required.' });
        return;
    }
...
static validateGermanPersonalausweis(req: Request, res: Response): void {
    ...
    if (!idNumber) {
        res.status(400).json({ error: 'German Personalausweis Number is required.' });
        return;
    }
